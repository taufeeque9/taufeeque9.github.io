...
```
For pushing static website to server, build it by providing correct url (https://www.cse.iitb.ac.in) and baseurl (/~taufeeque) in _config.yml<br><br><br><br>
